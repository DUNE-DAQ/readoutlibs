...
local readoutconfig = {
    ...
    rawdataprocessorconf : s.record("RawDataProcessorConf", [
            ...
            s.field("tpg_rs_memory_factor", self.pct, 0.8,
                            doc="Memory factor (R) for the TPG running sum algorithms"),                            
            s.field("tpg_rs_scale_factor", self.count, 2,
                            doc="Scale factor for the TPG running sum algorithms"),                              
            s.field("tpg_frugal_streaming_accumulator_limit", self.count, 10,
                            doc="Accumulator limit for the frugal streaming method"),    
