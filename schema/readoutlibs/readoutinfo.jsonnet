...
local info = {
   ...
   requesthandlerinfo: s.record("RequestHandlerInfo", [
        ...
        s.field("num_periodic_sent",             self.uint8,     0, doc="Number of successful periodic data transmissions in between get_info calls"),
        s.field("num_periodic_send_failed",      self.uint8,     0, doc="Number of failed periodic data transmissions in between get_info calls"),
